...
async def kickme(leave):
    ...
    await leave.edit("`Master Telah Meninggalkan Grup`")
...
async def mute_chat(mute_e):
    ...
    await mute_e.edit("`🤫 Master Telah Membisukan Obrolan ini!`")
    await sleep(2)
    await mute_e.delete()
    if BOTLOG:
...
async def get_chatinfo(event):
    ...
    try:
        ...
        try:
            ...
            await event.edit("`Ini Adalah Grup/Channel Privasi Atau Saya Dibanned Dari Sana`")
            return None
