...
async def locks(event):
    ...
    if input_str == "msg":
        ...
        if not input_str:
            await event.edit("`Apa Yang Harus Saya Kunci?`")
            return
        else:
    ...
    try:
        ...
        await event.edit(f"`Saya Telah Mengunci {what} Untuk Obrolan Ini`")
    except BaseException as e:
        await event.edit(
            f"`Apakah Saya Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}")
        return
...
async def rem_locks(event):
    ...
    try:
        ...
        await event.edit(f"`Saya Telah Membuka Kunci {what} Untuk Obrolan Ini`")
    except BaseException as e:
        await event.edit(
            f"`Apakah Saya Mempunyai Izin Melakukan Itu Disini?`\n**Kesalahan:** {str(e)}")
        return
