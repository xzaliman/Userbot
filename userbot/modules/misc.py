...
async def killdabot(event):
    ...
    await event.edit("`Mematikan Userbot....`")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Userbot Repo](https://github.com/xzaliman/xzaliman-userbot/blob/Lord-Userbot/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "**Repo Userbot:** [Userbot](https://github.com/xzaliman/xzaliman-userbot)\n**Pemilik:** [A5N](t.me/xz5pd)"
    )
