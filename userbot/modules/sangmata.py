...
async def lastname(steal):
    ...
    if message.sender.bot:
        ...
        return
    await steal.edit("```Proses Mengambil Informasi Riwayat Pergantian Nama Orang Ini```")
    try:
        async with bot.conversation(chat) as conv:
            try:
                ...
                await steal.reply(
                    "```Unblock @sangmatainfo_bot Dan Coba Lagi```"
                )
                return
        ...
        return await steal.edit("`Saya Sedang Sakit, Maaf`")
