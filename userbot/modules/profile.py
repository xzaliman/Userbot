...
PP_TOO_SMOL = "```Gambar Terlalu Kecil, Gunakan Yang Lebih Besar.```"
PP_ERROR = "```Kegagalan Terjadi Saat Proses Gambar, Foto Profil Gagal Diubah.```"

BIO_SUCCESS = "```Bio Anda Berhasil Diubah.```"

NAME_OK = "```Nama Anda Berhasil Diubah.```"
USERNAME_SUCCESS = "```Username Anda Berhasil Diubah.```"
USERNAME_TAKEN = "```Username Itu Sudah Ada Yang Menggunakannya.```"
# ===============================================================
